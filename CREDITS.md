...
Harita/Bölge: Kuzeydere

Bu oyun, açık kaynak web oyun teknolojileri kullanılarak geliştirilmiştir.
Orijinal proje katkıları, lisans bildirimleri ve kullanılan teknolojiler için
LICENSE ve CREDITS.md dosyalarına bakınız.

Kaynak kod ve lisans bilgileri:
https://github.com/AnubisZk/anadolucraft-kuzeydere

Kullanılan teknolojiler:

- Vite
- TypeScript
- Web tabanlı oyun altyapısı
- Açık kaynak JavaScript/TypeScript kütüphaneleri
