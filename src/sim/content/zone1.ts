...
export const ZONE1_MOBS: Record<string, MobTemplate> = {
  ...
  gorrak: {
    id: 'gorrak', name: 'Acımasız Gorrak', minLevel: 6, maxLevel: 6, family: 'humanoid',
...
export const ZONE1_NPCS: Record<string, NpcDef> = {
  ...
  trader_wilkes: {
    ...
    greeting: 'Taze ekmek, temiz su, uygun fiyat. Ne vereyim?',
  },
  apothecary_lin: {
  ...
  smith_haldren: {
    ...
    questIds: [],
    vendorItems: [
      'batidere_arming_sword', 'bronzework_mace', 'vale_carving_knife', 'hickory_shortstaff',
      'batidere_chain_vest', 'valespun_robe', 'tanned_leather_jerkin',
      'hobnail_boots', 'batidere_wool_trousers',
    ],
    greeting: 'Kıvılcımlara dikkat $C. İyi çelik, yara iziyle mezar arasındaki farktır.',
  },
  fisherman_brandt: {
    id: 'fisherman_brandt', name: 'Balıkçı Osman', title: 'Eski Deniz Kurdu',
    ...
    questIds: ['q_murlocs'],
    greeting: 'Gırlmırlgırl— pardon, o balık adamları dinleye dinleye böyle oldum.',
  },
  foreman_odell: {
...
export const ZONE1_QUESTS: Record<string, QuestDef> = {
  ...
  q_bones: {
    ...
    text: 'Kuzeybatı tepesindeki eski harabe bir zamanlar şapeldi, avlusu da bir mezarlıktı. Bir şey ölüleri uykusundan uyandırdı. Onlara huzur ver $N — 8 Huzursuz Kemikler\'i toprağa geri gönder.',
